...
public class IndonesiaBatchRunsTest {
    ...
    public void policyMustHaveEffectOnAbundance() throws FileNotFoundException {
        ...
        FlexibleScenario scenario = yaml.loadAs(
            new FileReader(Paths.get("inputs", "tests", "fixed_recruits_indonesia.yaml").toFile()),
        ...
        for (int i = 0; i < 25; i++) {
            DataColumn column = state.getYearlyDataSet()
                .getColumn("Lutjanus malabaricus Abundance 0." + i + " at day " + 365);
