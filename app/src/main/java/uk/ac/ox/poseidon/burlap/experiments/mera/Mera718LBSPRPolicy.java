...
public class Mera718LBSPRPolicy {
    ...
    public static void main(String[] args) throws IOException {
        ...
        final AlgorithmFactory<? extends AdditionalStartable> factory = MeraOneSpeciesSlice1.ALL_OF_THEM.get(
            "LBSPR_season");
        ...
        MeraOneSpeciesSlice1.runSetOfScenarios(pathToScenarioFiles,
            ...
            new Consumer<Scenario>() {
                ...
                public void accept(Scenario scenario) {
                    ...
                    ((SPRAgentBuilderFixedSample) ((FlexibleScenario) scenario).getPlugins().get(1)).setUseTNCFormula(
                        false);
                    ((SPRAgentBuilderFixedSample) ((FlexibleScenario) scenario).getPlugins().get(2)).setUseTNCFormula(
                        false);
                }
            }
        );
