...
public class NoData718Slice6OptimizationProblem extends SimpleProblemDouble implements Serializable {
    ...
    public static void optimize(Path previousSuccesses) throws IOException {
        ...
        final NoData718Slice6OptimizationProblem optiProblem = yaml.loadAs(
            new FileReader(
...
//        );
    ...
    public static void prepareScenarios(
        ...
        final String nameOfCandidateFile
    ) throws IOException {
        ...
        for (int scenarioNumber = 0; scenarioNumber < allSuccesses.size(); scenarioNumber++) {
            ...
            final Pair<Integer, Integer> runResult = problem.runScenarioAndReturnFilterPassedAndBestYearPair(
                scenario,
                numberOfYearsToRun,
                firstValidYear
            );
            ...
            int yearOfShock = computeYearOfPriceShock(
                convertedLine[convertedLine.length - 1],
    ...
    public double computeErrorGivenScenario(
        ...
        final Pair<Integer, Integer> receipt = runScenarioAndReturnFilterPassedAndBestYearPair(
            scenario,
            yearsToRun,
            firstValidYear
        );
